...
# If you're using a custom directory for static files, ensure it's correctly set up
STATICFILES_DIRS = [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True 
EMAIL_HOST_USER = 'arminmaddah.a@gmail.com'
EMAIL_HOST_PASSWORD = 'ycflmmemkxdcuawr'
